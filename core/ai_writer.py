...
def cbl_adsense_structure_instruction(writing_style=None, category=None, title=None, language=None):
    ...
    s = style_raw.lower().replace(" ", "")

    structure_bank = {
        "자연 설명형": [
            "상황 공감 도입 → 쉬운 개념 설명 → 왜 필요한지 → 실제 예시 → 장점 → 주의할 점 → 정리",
            "문제 제기 → 독자가 겪는 불편함 → 기본 개념 → 해결 방향 → 활용 예시 → 체크포인트 → 결론",
            "생활/업무 상황 도입 → 핵심 용어 풀이 → 단계별 이해 → 실제 적용 장면 → 흔한 오해 → 마무리",
            "가벼운 질문으로 시작 → 배경 설명 → 핵심 내용 → 예시 비교 → 알아두면 좋은 점 → 요약",
            "최근 관심이 늘어난 이유 → 기본 원리 → 누구에게 필요한지 → 사용/적용 방법 → 주의사항 → 결론",
            "처음 접하는 사람 기준 설명 → 핵심 특징 → 장점과 한계 → 실제 활용 흐름 → FAQ → 마무리",
            "독자의 검색 의도 설명 → 핵심 개념 정리 → 구체적 사례 → 선택/판단 기준 → 정리",
            "현실적인 고민 제시 → 왜 헷갈리는지 → 쉽게 풀어쓴 설명 → 상황별 예시 → 실수 방지 팁 → 결론",
            "짧은 배경 이야기 → 본문 핵심 요약 → 세부 설명 → 실제 적용 → 확인해야 할 부분 → 마무리",
            "초보자 관점 도입 → 기본 구조 설명 → 장점 → 단점 → 추천 상황 → 최종 정리",
            "일상적인 비유로 시작 → 개념 연결 → 핵심 요소 설명 → 예시 → 주의할 점 → 결론",
            "왜 사람들이 찾는지 → 핵심 내용 → 세부 항목별 설명 → 실제로 도움 되는 부분 → 정리",
            "처음 알면 좋은 내용 → 중요 포인트 → 단계별 이해 → 활용 팁 → 자주 묻는 질문 → 마무리",
            "상황 설명 → 원인 또는 배경 → 핵심 해결책 → 구체적 방법 → 추가 팁 → 결론",
            "독자가 궁금해할 질문 제시 → 답변형 설명 → 세부 개념 → 사례 → 체크리스트 → 정리",
            "큰 그림 설명 → 세부 개념 나누기 → 실제 활용법 → 장단점 → 주의사항 → 결론",
            "기본 개념 → 왜 중요한지 → 어떻게 활용되는지 → 실제 예시 → 놓치기 쉬운 점 → 마무리",
            "초보자용 요약 → 자세한 설명 → 상황별 적용 → 실전 팁 → FAQ → 결론",
            "문제 상황 묘사 → 해결에 필요한 개념 → 적용 순서 → 결과 기대효과 → 주의점 → 정리",
            "검색자가 원하는 답 먼저 제시 → 배경 설명 → 핵심 내용 확장 → 예시 → 판단 기준 → 마무리",
            "짧은 결론 먼저 제시 → 이유 설명 → 배경 정리 → 구체적 사례 → 확인 포인트 → 결론 확장",
            "익숙한 상황으로 시작 → 낯선 개념을 풀어 설명 → 실제 활용 → 장점과 한계 → 정리",
            "흔한 오해 제시 → 올바른 개념 설명 → 사례로 이해 → 실무/생활 적용 → 마무리",
            "검색자가 놓치기 쉬운 부분 제시 → 기본 설명 → 핵심 포인트 → 주의사항 → FAQ → 결론",
            "왜 중요한 주제인지 설명 → 핵심 개념 → 세부 요소 → 실제 변화 → 독자가 확인할 점 → 정리",
            "간단한 예시 도입 → 개념 설명 → 관련 요소 확장 → 적용 상황 → 피해야 할 실수 → 마무리",
            "질문형 도입 → 쉬운 답변 → 자세한 설명 → 예시 → 추가로 알아둘 점 → 결론",
            "배경 설명 → 핵심 차이 설명 → 상황별 이해 → 활용 팁 → 주의사항 → 최종 정리",
            "실제 고민 사례 → 원인 설명 → 해결 기준 → 적용 방법 → 체크리스트 → 결론",
            "짧은 이야기식 도입 → 핵심 개념 → 단계별 설명 → 사례 → 독자 행동 가이드 → 마무리",
        ],
        "전문가 분석형": [
            "핵심 요약 → 시장/기술 배경 → 주요 변수 분석 → 장점 → 리스크 → 실무적 판단 기준 → 결론",
            "현재 흐름 진단 → 핵심 쟁점 → 세부 분석 → 영향 요인 → 대응 전략 → 전망",
            "분석 기준 제시 → 항목별 해설 → 실제 영향 → 한계 → 의사결정 포인트 → 정리",
            "개념 정의 → 구조적 원인 → 흐름 기반 해석 → 리스크 분석 → 전략적 시사점 → 결론",
            "주요 변화 요약 → 배경 요인 → 이해관계자 영향 → 기회 요인 → 위험 요인 → 전망",
            "핵심 이슈 도출 → 원인 분석 → 비교 기준 → 실무 적용성 → 한계와 보완점 → 결론",
            "전문가 관점 도입 → 핵심 지표 설명 → 세부 변수 → 예상 시나리오 → 대응 방향 → 정리",
            "문제의 본질 → 구조 분석 → 비용/효율 관점 → 리스크 관리 → 판단 기준 → 마무리",
            "산업/시장 맥락 → 핵심 트렌드 → 기술 또는 제도 분석 → 영향 범위 → 실무 포인트 → 전망",
            "핵심 결론 선제시 → 근거 분석 → 세부 항목 검토 → 반대 관점 → 종합 판단 → 결론",
        ],
        "경험 기반형": [
            "직접 겪을 법한 상황 도입 → 문제 인식 → 시도 과정 → 느낀 점 → 개선 팁 → 결론",
            "처음 접한 계기 → 기대했던 점 → 실제 사용/경험 → 좋았던 점 → 아쉬운 점 → 정리",
            "현장감 있는 사례 → 당시 문제 → 해결 과정 → 배운 점 → 독자에게 줄 팁 → 마무리",
            "개인적 관찰 도입 → 핵심 경험 설명 → 세부 장면 → 판단 기준 → 추천/주의사항 → 결론",
        ...
        "구매·리뷰형": [
            "구매 전 고민 → 제품/서비스 핵심 특징 → 실제 사용감 → 장점 → 단점 → 추천 대상 → 결론",
            "선택 이유 → 첫인상 → 주요 기능 → 체감 성능 → 아쉬운 부분 → 구매 판단 기준 → 정리",
            "비교 대상 제시 → 핵심 차이 → 가격/효율 → 사용 후기 → 추천 상황 → 마무리",
            "구매 목적 → 기대 포인트 → 실제 만족도 → 불편한 점 → 대안 비교 → 결론",
            "상품 개요 → 주요 스펙/특징 → 사용 장면 → 장단점 → 누구에게 맞는지 → 정리",
        ...
        "뉴스·트렌드형": [
            ...
            "최근 변화 소개 → 왜 주목받는지 → 핵심 내용 → 시장/사용자 영향 → 체크 포인트 → 결론",
            ...
            "화제가 된 이유 → 핵심 내용 → 관련 산업/생활 영향 → 장단점 → 전망",
        ...
        "체크리스트형": [
            ...
            "핵심 요약 → 체크 항목 1차 → 체크 항목 2차 → 위험 신호 → 마무리",
    ...
    def detect_style_key(raw):
        ...
        if "체크" in raw or "checklist" in compact:
            return "체크리스트형"
        if "자연" in raw or "설명" in raw or "natural" in compact:
            return "자연 설명형"
    ...
    paragraph_rules = [
        ...
        "중간중간 실제 상황 예시를 넣어 사람이 직접 설명하는 글처럼 만든다.",
    ]

    anti_pattern_rules = [
        "매번 같은 '정의-장점-단점-결론' 순서를 반복하지 않는다.",
...
아래 지시는 글 작성 품질을 높이기 위한 내부 작성 규칙이다. 이 블록 제목이나 규칙 문구를 본문에 그대로 출력하지 마라.

- 반드시 기존 프롬프트가 요구한 언어를 유지한다. 한국어 글은 한국어로, 영어 글은 영어로 작성한다.
